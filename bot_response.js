function botResponse(userMessage) {
    ...
    const responses = {
        ...
        "tabela trigonométrica": "Aqui está a imagem: <br> <br> <img src='chatbot_img/tabela trigonométrica.jpeg' alt='Imagem tabela trigonométrica 1' width='700px' <br> Imagem:<a href='https://www.passeidireto.com/arquivo/56554411/tabela-trigonometrica' target='_blank'>Passei Direto</a>. <br> <br> <img src='chatbot_img/tabela trigonométrica2.webp' alt='Imagem tabela trigonométrica 2' width='700px' <br> Imagem:<a href='https://brasilescola.uol.com.br/matematica/seno-cosseno-tangente-angulos.htm' target='_blank'>Brasil Escola</a>.",
        "tabela trigonometrica": "Aqui está a imagem: <br> <br> <img src='chatbot_img/tabela trigonométrica.jpeg' alt='Imagem tabela trigonométrica 1' width='700px' <br> Imagem:<a href='https://www.passeidireto.com/arquivo/56554411/tabela-trigonometrica' target='_blank'>Passei Direto</a>. <br> <br> <img src='chatbot_img/tabela trigonométrica2.webp' alt='Imagem tabela trigonométrica 2' width='700px' <br> Imagem:<a href='https://brasilescola.uol.com.br/matematica/seno-cosseno-tangente-angulos.htm' target='_blank'>Brasil Escola</a>.",
        "círculo trigonométrico": "Aqui está a imagem: <br> <br> <img src='chatbot_img/círculo trigonométrico.jpeg' alt='Imagem círculo trigonométrico 1' width='700px' <br> Imagem:<a href='https://www.unirio.br/ppgan/matlabbio/atividades-interativas/trabalhando-ciclo-trigonometrico' target='_blank'>Unirio</a>. <br> <br> <img src='chatbot_img/círculo trigonométrico2.jpeg' alt='Imagem círculo trigonométrico 2' width='700px' <br> Imagem:<a href='https://grupoevolucao.com.br/livro/Matematica2/relaes_trigonomtricas.html' target='_blank'>Grupo Evolução</a>.",
